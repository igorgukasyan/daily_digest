...
print(f"Word 'да' appeared {model.wv.get_vecattr('да', 'count')} times in the training corpus.")
## train model
...
train_vectors.to_csv('train_vectors.csv', index = False)
...
test_vectors.to_csv('test_vectors.csv', index = False)
